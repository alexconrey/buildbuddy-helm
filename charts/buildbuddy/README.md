...
| `image.tag`                          | Container image tag                                                                                                                                                                                                                                                                                                         | `v2.19.0`                                                                                                                  |
...
| `ingress.http.annotations`           | HTTP-specific ingress annotations traffic                                                                                                                                                                                                                                                                                  | `[]`                                                                                         |                                                                                           |                                                                                                |
| `ingress.grpcHost`                   | The hostname that will handle grpc traffic                                                                                                                                                                                                                                                                                  | `[buildbuddy-grpc.example.com]`
| `ingress.grpc.annotations`           | GRPC-specific ingress annotations traffic                                                                                                                                                                                                                                                                                  | `[]`                                                                                         |                                                                                           |
